...
) ENGINE = InnoDB AUTO_INCREMENT = 66 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '视频信息评论表' ROW_FORMAT = Dynamic;
...
INSERT INTO `token` VALUES (4, 1717298167268, '1234567', 'users', '用户', 'kg2pn2to0ldv62epdxvepwceukppdwi9', '2024-06-02 11:18:43', '2024-06-02 14:56:19');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1717323412958 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户' ROW_FORMAT = Dynamic;
...
CREATE TABLE `videos`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '视频信息' ROW_FORMAT = Dynamic;
